...
# TC-EOG-SRC-05: exactly TWO `gh pr view ... --json state` queries now exist —
...
# smoke-FAIL abort site → 11; INV-78 (#234) added the mandatory-bot-review hard
...
assert_eq "TC-EOG-REG-04 emit_verdict_trailer call count is 13 (10 + INV-64 smoke abort + INV-78 bot-review gate x2; open-guard adds none)" \
  "13" "$_trailer_count"
