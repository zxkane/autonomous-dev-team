...
#     (#488). BLOCK_SLICE is a mktemp function-slice fixture (the INV-135 D4
...
#     bash-c-boundary shape as test-w1d-ci-status-mergeable-parity.sh's
#     _W1D_LIB_DISPATCH waiver above (the gh stub precedes the source in the
#     SAME bash -c scope).
WAIVERS=(
  ...
  "test-autonomous-review-inv134-matched-patterns.sh:dynamic-source:BLOCK_SLICE is a mktemp function-slice fixture (the INV-135 D4 matched-patterns block extracted from the wrapper)"
)
