...
# routes through the existing FAIL branch's trailer). The total is 13 = the 10
...
# substantive FAIL) PLUS the 4 INV-134 CI-rollup gate sites (issue #489:
# head-changed + failed-check substantive + awaiting-ci/unavailable wait +
# wait-max substantive give-up) — the veto itself still contributes none.
#
