...
E2E_ACTIVE == true:
  PHASE A — run the E2E lane ONCE, to completion:
    command mode → _run_command_e2e_lane (lib-review-e2e.sh): a PURE SHELL subshell
        ...
        INV-47: also extracts the OPTIONAL structured AC-coverage artifact from the
