...
E2E_ACTIVE == true:
  PHASE A — run the E2E lane ONCE, to completion:
    ...
    browser mode → ONE LLM lane (run_agent against build_browser_e2e_prompt). The
        LLM WRITES its `## E2E Verification Report` to $E2E_REPORT_FILE (the INV-78
