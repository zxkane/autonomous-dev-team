...
- A malformed, absent, or non-matching prior marker parses to a stored count of `0`, so the fresh series starts at the composed `count = 1` (bias to MISS, never a crash).
